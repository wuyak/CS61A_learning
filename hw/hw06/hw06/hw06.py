...
def deep_map_mut(func, s):
    ...
    "*** YOUR CODE HERE ***"
    """
    the s.first could also be a Link!!!
    you'd bettr check
    if it is
    recursive it!!
    """
...
#         return Link(value, repeat_value(value, count-1))
#     return repeat_value(vals[0], counts[0])
