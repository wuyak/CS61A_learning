...
class BankAccount:
    ...
    def add_transaction(self, before, after):
        transaction = Transaction(self.next_id(), before, after)
    ...
    def deposit(self, amount):
        ...
        self.add_transaction(before, self.balance)
        return self.balance
...
class Coin:
    ...
    def worth(self):
        ...
        ex_worth = max(0, age - 50)
        return self.cents + ex_worth
# don not change the self.cents !!! so use
# self.cents += is wrong !!!
