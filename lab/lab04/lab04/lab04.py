...
def distance(city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    distance_lat = abs(get_lat(city_a) - get_lat(city_b))
    distance_lon = abs(get_lon(city_a) - get_lon(city_b))
...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    city_current = make_city('city_current', lat, lon)
    distance_a = distance(city_current, city_a)
    distance_b = distance(city_current, city_b)
