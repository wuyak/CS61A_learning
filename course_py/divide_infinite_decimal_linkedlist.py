...
def divide(n, d):
    ...
    "*** YOUR CODE HERE ***"
    """
    why the first will change be not 0
    i don not understand this (fixed)
    """
#    for _ in range(100):
#        n *= 10
#        result.rest, n = Link(n // d), n % d
#        result = result.rest
#    return result
    """
    amzing, it uses a clever approach that also interpret
    why p/q results in a infinite repeating decimal
    """
    cache = {}
    tail = result
